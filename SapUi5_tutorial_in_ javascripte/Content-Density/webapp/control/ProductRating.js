sap.ui.define([
	...
	return Control.extend("ui5.walkthrough.control.ProductRating", {
		...
		init() {
			...
			}).addStyleClass("sapUiTinyMarginTopBottom sapUiSmallMargin"));
		},
		...
		_onRate(oEvent) {
			...
			this.getAggregation("_label").setText(oRessourceBundle.getText("productRatingLabelIndicator", [Value, oEvent.getSource().getMaxValue()]));
